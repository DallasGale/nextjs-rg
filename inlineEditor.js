...
(function (AbcNews) {
  var AbcImageInlineEditor = /** @class */ (function () {
    function AbcImageInlineEditor() {
      ...
      this.title = "ABC-Image";
      this.description = "Insert an image from an URL, or upload one";
      this.fontAwesomeClass = "fa-image";
    }
          ...
          NcHtml.jsxFactory(
            ...
            NcHtml.jsxFactory(
              ...
              NcHtml.jsxFactory(
                ...
                NcHtml.jsxFactory("i", { class: "fa fa-cloud-upload" })
              )
            )
          )
        )
      ...
      function click() {
        ...
        if (!rawLink || (rawLink && rawLink.length === 0)) {
          ...
          bulletinBackend
            ...
            .then(function (d) {
              if (d.image) {
                var largeMaxResolution = [1200, 800];
                bulletinBackend
                  .uploadImageFromUrl(
                    d.image.url,
                    largeMaxResolution[0],
                    largeMaxResolution[1]
                  )
